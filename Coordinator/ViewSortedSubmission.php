...
<body>
   ...
   echo "<h1 style='text-align: center; margin-top: 50px;'>Students' Submitted Application List</h1>
   <h3 style='margin-left: 180px;'>(Sorted by Application Date)</h3>";
   ...
   $array = array();
   $select = "SELECT * from practical_training where applicationstatus='submitted' order by applicationdate";
